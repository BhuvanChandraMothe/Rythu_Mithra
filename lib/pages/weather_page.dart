...
import 'package:rythu_mithra/components/global_controller.dart';
...
class _WeatherPageState extends State<WeatherPage> {
  ...
  Future<List<forecast>> getweather() async {
    ...
    Response r = await get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/onecall?lat=${p.latitude}&lon=${p.longitude}&exclude=hourly,minutely&appid=e0c9b6ff1e01f2a9fe6aa3e4a23c7083"));
    //print(r.body);
